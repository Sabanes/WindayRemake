    ...
    <section ref={sectionRef} className="py-20 bg-[#e5e5e5] overflow-hidden">
      <div className="container mx-auto max-w-7xl px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#493F0B] mb-8">
          ...
          >
            <p className="text-base md:text-lg text-[#493F0B]/80 italic">Fundador de Winday, Mykola Spaskiy</p>
          </div>
        </div>
      </div>
    </section>
