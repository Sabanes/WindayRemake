        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <p className="text-white/90 text-lg max-w-xl">
              Sua escolha ideal para janelas que abrem novos horizontes. Nossas janelas e portas em PVC e alumínio são
              duráveis, isolantes e de design moderno.
            </p>
            ...
            <div className="space-y-3">
              ...
              <p className="text-white/80 text-sm flex items-center">
                <Check className="h-4 w-4 mr-2" /> Orçamento gratuito e sem compromisso
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
              <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
                <h3 className="text-white font-bold">Durabilidade</h3>
                <p className="text-white/80 text-sm">Resistente às intempéries</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
                <h3 className="text-white font-bold">Isolamento</h3>
                <p className="text-white/80 text-sm">Térmico e acústico</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
                <h3 className="text-white font-bold">Design</h3>
                <p className="text-white/80 text-sm">Moderno e elegante</p>
              </div>
            </div>
          </div>
