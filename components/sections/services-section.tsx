    ...
    <section id="servicos" className="py-20 bg-[#d3d3d3]">
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#493F0B] mb-4">Nossos Serviços</h2>
          <p className="text-[#493F0B]/80 max-w-2xl mx-auto">
            Oferecemos um serviço completo, desde a medição até a manutenção, garantindo qualidade em todas as etapas.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <ServiceCard
            ...
            description="Avaliação técnica e consultoria personalizada para encontrar a melhor solução para seu espaço."
          ...
          <ServiceCard
            ...
            description="Produção de janelas e portas em PVC com materiais de alta qualidade e tecnologia avançada."
          ...
          <ServiceCard
            title="Instalação"
            description="Instalação profissional realizada por técnicos especializados, garantindo perfeito funcionamento."
          ...
          <ServiceCard
            title="Manutenção"
            description="Serviços de manutenção preventiva e corretiva para prolongar a vida útil de seus produtos."
